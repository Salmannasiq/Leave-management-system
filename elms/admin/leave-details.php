...
$NAME;
$NAME1;
$SQL1="select * from tblemployees where id='$EMPID'";
$QUERY2=mysqli_query($con,$SQL1);
while($R1=mysqli_fetch_array($QUERY2))
{
	$EMAIL=$R1['EmailId'];
	$NAME=$R1['FirstName'];
	$NAME1=$R1['LastName'];
}
$N1=array('1'=>"Approved",'0'=>"Pending",'2'=>"Not Approved");
$FNAME=$NAME." ".$NAME1;
$headers = "MIME-Version: 1.0" . "\r\n";
$headers .= "Content-type:text/html;charset=UTF-8" . "\r\n";
$msg="<b><h2 style='color:#4CAF50'>Status of Your Leave Request</h2><br><br><table border='2'><tr><th>Your Name</th><th>Status of Your Leave Request</th></tr>";
$FSTATUS=$N1[$status];
$msg.="<tr><td>'$FNAME'</td><td>'$FSTATUS'</td></tr>";
?>


<?php
mail($EMAIL,"Status",$msg,$headers);
